				...
				<ul class="navbar-nav ml-auto">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<li class="nav-item"><div id="profile" onclick="location.href='chacarge_mypage_privacy.do?user_id=${login.user_id}'" style="cursor:pointer;">&nbsp;&nbsp;로그인 유저 : ${login.user_id}&nbsp;&nbsp;</div></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
