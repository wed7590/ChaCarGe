...
<%
	ArrayList<AdminTO> statistics_member = (ArrayList)request.getAttribute("statistics_member");

	// sbHtmlManagement 안에 회원 가입자 수 데이터 담아서 html 양식으로 출력
	StringBuffer sbHtmlMember = new StringBuffer();
	
	for (AdminTO to : statistics_member) {
...
<!-- 페이지 내용 -->
	...
	<!-- 페이지 경로 표시 -->
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item">회원 통계</li>
		</ol>
					    ...
					    <div class="container">
						    <article class="docs-article" id="section-1">
								<section class="docs-section" id="item-1-1">
									<h4 class="section-heading">회원 수 통계</h4>
									<div class="board">
